...
[Working Application - Deployed](https://alpineways-app.netlify.app/)

- alpineways-html - working html/css/javascript project (contains assets)
...
```sh
npx create-react-app@latest alpineways-app
```
...
// JSX
;<img src={logo} className='nav-logo' alt='alpineways' />
```
